...
export default function PageConnexion() {
    ...
    return (
        <div className='p-4 pt-8 max-w-md mx-auto flex flex-col items-center'>
            ...
            {messageSucces && (
                <div role="status" className="bg-green-100 text-green-800 p-4 rounded-lg mb-6 text-center font-bold w-full">
                    {messageSucces}
                </div>
            )}

            {erreurGenerale && (
                <div role="alert" className="bg-red-100 text-red-800 p-4 rounded-lg mb-6 text-center font-medium w-full">
                    {erreurGenerale}
                </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="w-full flex flex-col items-center">
                ...
                >
                    <div className="flex items-center justify-center bg-white text-gray-700 font-semibold py-3 px-6 rounded-lg border border-gray-300 hover:bg-gray-50 transition-colors shadow-sm cursor-pointer mb-2">
