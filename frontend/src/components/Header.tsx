...
export default function Header() {
    ...
    function NavMobile(){
        return (
            <ul className='hidden nav-mobile'>
                <Link to="/">Home</Link>
